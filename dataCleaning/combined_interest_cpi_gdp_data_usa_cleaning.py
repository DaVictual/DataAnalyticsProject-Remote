...
df = pd.DataFrame.from_dict(data = combined_cleaned_interest_inflation_gdp_data_1954_to_2017, orient="index", columns=["interest_rate", "inflation", "gdp"])
...
# print(combined_cleaned_interest_inflation_gdp_data_1954_to_2017)